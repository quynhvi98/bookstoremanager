...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="width: 437px; margin-left: 50px; margin-top: 0px; height: auto; float: left;">
        ...
        <div>
            ...
            <asp:RequiredFieldValidator ControlToValidate="txtAuthorDescription" ID="RequiredFieldValidator2" runat="server" ErrorMessage="Vui lòng Nhập mô tả"></asp:RequiredFieldValidator>
